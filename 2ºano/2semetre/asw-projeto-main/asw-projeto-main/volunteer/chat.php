...
$infoLogged = Instituicao::getOne($id_instituicao);

$id = $infoLogged->id;
$nome = $infoLogged->nome;
$foto = $infoLogged->foto;

$updateChat = MensagemVoluntario::selectChat($id, $id_voluntario)
?>
<!--
